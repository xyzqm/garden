...
2. from here, it remains to determine which specific LPS to pick. we refer to a bracket in a 0-pair as **matched**, otherwise **unmatched**. then, if there exists an unmatched ) between a 0-pair, it cannot be worse to match the left bracket of this 0-pair to the ) instead. 
